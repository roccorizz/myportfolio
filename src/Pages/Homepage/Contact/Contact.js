    ...
    return (
        <div className="lg:mx-80 mx-20 ">
            <form
                ...
                target="_blank"
            >
                <h1 className="text-center font-bold  text-orange-400">Contact Me</h1>
                <h1 className="text-center text-xl  text-white">Please fill up the boxes and send me if you have any query</h1>
